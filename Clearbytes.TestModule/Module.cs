...
namespace Clearbytes.TestModule
{
    [ClearbytesModuleAttributes("Test module", "This is a test module, you shouldn't be able to see this in a public release.")]
    public class Module : ClearbytesModule
    {
        public override void Search()
        {
            this.AddInformation("Some text node", InformationType.Text, "Some magical text data");
            this.AddInformation("Some image node", InformationType.Image, Properties.Resources.testimg);
            ...
            this.AddInformation("Some expandable node", InformationType.Title, new TitleInfo("Some title", "Some description"))
                .AddInformation("Some nested text node", InformationType.Text, "Some magical nested data", true)
                    .AddInformation("Some nested image node", InformationType.Image, Properties.Resources.testimg, true)
